<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewShirt.aspx.cs" Inherits="Spruce.ViewShirt" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="AllStyles">
            <div class="collarStyles">
                <div class="col-6 p-1">
                    <div class="drag CollarStyle1 collars" data-style="Large Spread" data-style-name="Large Spread">
                ...
                <div class="col-6 p-1">
                    <div class="drag CollarStyle2 collars" data-style="Classic">
                ...
                <div class="col-6 p-1">
                    <div class="drag CollarStyle3 collars" data-style="Rounded With Button">
                ...
                <div class="col-6 p-1">
                    <div class="drag CollarStyle4 collars" data-style="Rounded Without Button">
                ...
                <div class="col-6 p-1">
                    <div class="drag CutAwayExtra collars" data-style="Cut Away Extra">
                ...
                <div class="col-6 p-1">
                    <div class="drag CollarStyle5 collars" data-style="Cut Away">
                ...
                <div class="col-6 p-1">
                    <div class="drag CollarStyle-6 collars" data-style="Bottom Down">
                ...
                <div class="col-6 p-1">
                    <div class="drag CollarStyle-7 collars" data-style="Wing or Tuxedo">
                ...
                <div class="col-6 p-1">
                    <div class="drag CollarStyle-8 collars" data-style="Narrow Bottom">
        ...
        <!-- Cuff Started -->
            <div class="cuffStyles">
            <div class="col-6 p-1">
                <div class="drag CuffDesign1 cuffs" data-style="French">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign2 cuffs" data-style="One Button">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign3 cuffs" data-style="Two Button">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign4 cuffs" data-style="Three Button">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign5 cuffs" data-style="One Button Cut">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign6 cuffs" data-style="Two Button Cut">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign7 cuffs" data-style="Large Rounded">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign8 cuffs" data-style="Square">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign8 cuffs" data-style="Barrel">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign8 cuffs" data-style="Envelope">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
            ...
            <!-- Cuff -->
            <div class="col-6 p-1">
                <div class="drag CuffDesign11 cuffs" data-style="Italian">
                    <div class="m-0 CuffSideFlex">
                        <div class="CuffSides">
        ...
        <div class="MainStyle">
            ...
            <div class="mt-4">
                <div class="text-center">
                    <h1>View Your Desinged Shirt</h1>
                </div>
                <div class="text-right">                    
                    <asp:LinkButton ID="LinkButton1" Visible="false" OnClick="LinkButton1_Click" CssClass="btn btn-main" runat="server">Go Back</asp:LinkButton>
                    <asp:LinkButton ID="LinkButton2" Visible="false" OnClick="LinkButton2_Click" CssClass="btn btn-main" runat="server">Go Back</asp:LinkButton>
                </div>
            </div>
            <div class="main_shirt_image canvas m-auto">
        ...
        <asp:HiddenField ID="ThreadColorHiddenField" runat="server" />
        <asp:HiddenField ID="CuffStyleHiddenField" runat="server" />
        <asp:HiddenField ID="ButtonStyleHiddenField" runat="server" />
        <asp:HiddenField ID="ButtonColorHiddenField" runat="server" />
        <asp:HiddenField ID="PocketStyleHiddenField" runat="server" />
        <asp:HiddenField ID="MadeToMeasureHiddenField" runat="server" />
        <asp:HiddenField ID="CollarStyleHiddenField" runat="server" />
        <asp:HiddenField ID="FabricImageHiddenField" runat="server" />
    </form>
    ...
    <script>
        ...
        let ShirtStyle = $("#<%=ShirtStyleHiddenField.ClientID%>").val();
        let ThreadColor = $("#<%=ThreadColorHiddenField.ClientID%>").val();
        let CuffStyle = $("#<%=CuffStyleHiddenField.ClientID%>").val();
        let ButtonStyle = $("#<%=ButtonStyleHiddenField.ClientID%>").val();
        let ButtonColor = $("#<%=ButtonColorHiddenField.ClientID%>").val();
        let PocketStyle = $("#<%=PocketStyleHiddenField.ClientID%>").val();
        let MadeToMeasure = $("#<%=MadeToMeasureHiddenField.ClientID%>").val();
        let CollarStyle = $("#<%=CollarStyleHiddenField.ClientID%>").val();
        let FabricImg = $("#<%=FabricImageHiddenField.ClientID%>").val();

        $("svg image").attr("xlink:href", FabricImg);
        console.log(ShirtStyle)
        console.log(FabricImg)
        if (ShirtStyle == "Simple Shirt") {
            let simpleShirt = $("#SimpleShirt");
            simpleShirt.appendTo($(".canvas"));
        } else {
            let longBottom = $("#LongBottomShirtDesign");
            longBottom.appendTo($(".canvas"))
        }
        console.log(CollarStyle)

        $(".collars").each(function () {
            if ($(this).attr("data-style") == CollarStyle) {
                $(this).appendTo($(".canvas"));
            }
        })
        $(".cuffs").each(function () {
            if ($(this).attr("data-style") == CuffStyle) {
                $(this).appendTo($(".canvas")); 
                $(".canvas .CuffSides").clone().appendTo(".canvas .CuffSideFlex");
            }
        })
        $(".buttons").appendTo($(".canvas"))
        if ($(".canvas .buttonContainer").length <= 1) {
            for (var i = 0; i < 6; i++) {
                $(".canvas .btnContainerInner").first().clone().appendTo(".canvas .buttonContainer");
            }
        }
        $(".pocket").appendTo($(".canvas"));
        ...
        } else if (ButtonColor == "blackColor") {
            $(".btnColorChange").css({
                'fill': "black"
            })
            $(".Button-1-cls-2").css({
        ...
        } else if (ButtonColor == "Light_blue") {
            $(".btnColorChange").css({
                "fill": "lightblue"
            })
            $(".Button-1-cls-2").css({
        ...
        } else if (ButtonColor == "Dark_Green") {
            $(".btnColorChange").css({
                'fill': 'darkgreen'
            })
            $(".Button-1-cls-2").css({
        ...
        } else if (ButtonColor == "Yellow_Orange") {
            $(".btnColorChange").css({
                "fill": "#ffcc00"
            })
            $(".Button-1-cls-2").css({
        ...
        } else if (ButtonColor == "Blue_violet") {
            $(".btnColorChange").css({
                'fill': "#4d1a7f"
            })
            $(".Button-1-cls-2").css({
        ...
        $(".download_img");
        const SaveBtn = document.querySelector(".download_img");
