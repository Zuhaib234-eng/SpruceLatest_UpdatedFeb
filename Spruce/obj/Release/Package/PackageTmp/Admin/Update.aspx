<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Spruce.Admin.Update" %>
...
<body>
            ...
            <div id="content" class="p-4 p-md-5 pt-5">
                <div class="container">
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="DiscountedPriceTextBox" TextMode="Number" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group galleryUpload">
                            ...
                            <div class="colors">
                                ...
                                <div class="row m-0">
                                    ...
                                    <asp:DropDownList runat="server" ID="ColorDropDownList" CssClass="form-control">
                                            ...
                                            <asp:ListItem CssClass="BlueColor" runat="server">Blue</asp:ListItem>
                                            <asp:ListItem Value="NavyBlue" CssClass="btn" runat="server">Navy Blue</asp:ListItem>
                                            <asp:ListItem Value="WhiteColor" CssClass="btn" runat="server">White</asp:ListItem>
                                            <asp:ListItem Value="BlackColor" CssClass="btn" runat="server">Black</asp:ListItem>
                                            <asp:ListItem Value="GreyColor" CssClass="btn" runat="server">Grey</asp:ListItem>
                                            <asp:ListItem Value="PinkColor" CssClass="btn" runat="server">Pink</asp:ListItem>
                                            <asp:ListItem Value="MaroonColor" CssClass="btn" runat="server">Maroon</asp:ListItem>
                                            <asp:ListItem Value="PurpleColor" CssClass="btn" runat="server">Purple</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="btnContainer text-right">
                        <asp:Button ID="ProceedButton" OnClick="ProceedButton_Click" CssClass="btn btn-primary btn-block" runat="server" Text="Update" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        if (success == "Success") {
            ...
            var succesIcon = 'Assets/Images/successIcon.jpg';
