<%@ Page Title="Sign In" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="Spruce.SignIn" %>
                ...
                <div class="row m-0 fl-reverse">
                    ...
                    <div class="col-lg-6">
                        <div class="existingCustomer mt-4">
                            ...
                            <p>Enter your credentials here to sign in</p>
                            <div class="signInFields">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="PasswordTextbox" placeholder="Password" CssClass="form-control" TextMode="Password" required runat="server"></asp:TextBox>
                                </div>
                                <!-- <div class="forget"><a href="#">Forget Password ?</a></div> -->
                                <asp:Button ID="SignInBtn" OnClick="SignInBtn_Click" CssClass="btn btn-main mt-4 btn-block" runat="server" Text="Sign In" />
                                <div class="text-right mt-3">
                                    <asp:LinkButton ID="ForgetPassword" OnClick="ForgetPassword_Click" runat="server">Forgot Password ?</asp:LinkButton>
                                </div>
                            </div>
                        </div>
                        <hr class="d-lg-none">
